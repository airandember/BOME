...
func CreateStripeEntity(db *database.DB, entityType, entityID string, localID int, metadata map[string]interface{}) (*StripeEntity, error) {
	...
	return GetStripeEntityByID(db, id)
}

// GetStripeEntityByID retrieves a Stripe entity by ID
func GetStripeEntityByID(db *database.DB, id int) (*StripeEntity, error) {
	entity := &StripeEntity{}
	err := db.QueryRow(
...
func GetStripeEntityByStripeID(db *database.DB, entityType, entityID string) (*StripeEntity, error) {
	entity := &StripeEntity{}
	err := db.QueryRow(
		`SELECT id, entity_type, entity_id, local_id, metadata, created_at, updated_at 
...
func GetStripeEntityByLocalID(db *database.DB, entityType string, localID int) (*StripeEntity, error) {
	entity := &StripeEntity{}
	err := db.QueryRow(
		`SELECT id, entity_type, entity_id, local_id, metadata, created_at, updated_at 
...
func UpdateStripeEntityMetadata(db *database.DB, id int, metadata map[string]interface{}) error {
	var metadataJSON sql.NullString
	if metadata != nil {
		jsonData, err := json.Marshal(metadata)
		if err != nil {
...
func DeleteStripeEntity(db *database.DB, id int) error {
...
func GetStripeEntitiesByType(db *database.DB, entityType string, limit, offset int) ([]*StripeEntity, error) {
	rows, err := db.Query(
		`SELECT id, entity_type, entity_id, local_id, metadata, created_at, updated_at 
