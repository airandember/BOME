...
func logWebhookEventToDB(syncService *stripeSvc.StripeSyncService, eventType, endpoint, status string, responseTime int, payloadSize int, statusCode int, errorMessage string) {
...
func RegisterStripeWebhookRoutes(router *gin.RouterGroup, stripeService *stripeSvc.StripeService, syncService *stripeSvc.StripeSyncService) {
...
func HandleStripeWebhook(c *gin.Context, stripeService *stripeSvc.StripeService, syncService *stripeSvc.StripeSyncService) {
	startTime := time.Now()
...
func processV1Event(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handleCustomerCreated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handleCustomerUpdated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var customer stripe.Customer
	if err := json.Unmarshal(event.Data.Raw, &customer); err != nil {
		return err
	}
...
func handleCustomerDeleted(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var customer stripe.Customer
	if err := json.Unmarshal(event.Data.Raw, &customer); err != nil {
		return err
	}
...
func handleInvoicePaymentSucceeded(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handleInvoicePaymentFailed(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var invoice stripe.Invoice
	if err := json.Unmarshal(event.Data.Raw, &invoice); err != nil {
		return err
	}
...
func handleProductCreated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handleProductUpdated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var product stripe.Product
	if err := json.Unmarshal(event.Data.Raw, &product); err != nil {
		return err
	}
...
func handlePriceCreated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handlePriceUpdated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var price stripe.Price
	if err := json.Unmarshal(event.Data.Raw, &price); err != nil {
		return err
	}
...
func handleSubscriptionCreated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
...
func handleSubscriptionUpdated(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var subscription stripe.Subscription
	if err := json.Unmarshal(event.Data.Raw, &subscription); err != nil {
		return err
	}
...
func handleSubscriptionDeleted(event *stripe.Event, syncService *stripeSvc.StripeSyncService) error {
	var subscription stripe.Subscription
	if err := json.Unmarshal(event.Data.Raw, &subscription); err != nil {
		return err
	}
...
func getWebhookStatus(c *gin.Context, syncService *stripeSvc.StripeSyncService) {
...
func pingWebhook(c *gin.Context, syncService *stripeSvc.StripeSyncService) {
...
func getWebhookLogs(c *gin.Context, syncService *stripeSvc.StripeSyncService) {
	// Get query parameters
	page := 1
	limit := 50
	eventType := c.Query("event_type")
	status := c.Query("status")
	_ = eventType // TODO: Re-implement filtering by event type
	_ = status    // TODO: Re-implement filtering by status
	...
	offset := (page - 1) * limit
	response, err := getWebhookEventsWithPagination(db, limit, offset)
	if err != nil {
	...
	log.Printf("📋 Webhook logs requested: page=%d, limit=%d, total=%d", page, limit, len(response))
	c.JSON(http.StatusOK, response)
}

// retryWebhookEvent retries a failed webhook event by re-processing it
func retryWebhookEvent(c *gin.Context, syncService *stripeSvc.StripeSyncService, stripeService *stripeSvc.StripeService) {
...
// Stub function for webhook events
func getWebhookEventsWithPagination(db *database.DB, limit, offset int) ([]interface{}, error) {
