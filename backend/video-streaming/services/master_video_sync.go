...
func (s *MasterVideoSyncService) SyncToBunny() (*SyncResult, error) {
	...
	videos, err := videoModels.GetMasterVideos(s.db, 1000, 0, "", "", "", "", "id", "desc")
	if err != nil {
...
func (s *MasterVideoSyncService) ResolveConflict(conflictID int, resolution *ConflictResolution, userID int) error {
	// Get the conflict
	conflicts, err := videoModels.GetSyncConflicts(s.db, nil)
	if err != nil {
		return fmt.Errorf("failed to get conflicts: %v", err)
	}

	var targetConflict *videoModels.SyncConflict
	...
	masterVideo, err := videoModels.GetMasterVideoByID(s.db, targetConflict.MasterVideoID)
	if err != nil {
	...
	err = videoModels.ResolveSyncConflict(s.db, conflictID, userID, resolution.Notes)
	if err != nil {
		return fmt.Errorf("failed to mark conflict as resolved: %v", err)
	}

	// Log the resolution
	audit := &videoModels.SyncAuditLog{
	...
	return videoModels.LogSyncAudit(s.db, audit)
}
...
func (s *MasterVideoSyncService) processBunnyVideo(bunnyVideo BunnyVideo, result *SyncResult, userID int) error {
	...
	_, err := videoModels.GetMasterVideoByBunnyID(s.db, bunnyVideo.GUID)
	if err != nil {
...
func (s *MasterVideoSyncService) createMasterVideoFromBunny(bunnyVideo BunnyVideo, result *SyncResult, userID int) error {
	...
	masterVideo := &videoModels.MasterVideo{
	...
	createdVideo, err := videoModels.CreateMasterVideo(s.db, masterVideo)
	if err != nil {
...
func (s *MasterVideoSyncService) updateMasterVideoFromBunny(masterVideo *videoModels.MasterVideo, bunnyVideo BunnyVideo, result *SyncResult) error {
	// Check for conflicts
	...
	return videoModels.UpdateMasterVideo(s.db, masterVideo)
}

func (s *MasterVideoSyncService) processMasterVideo(masterVideo *videoModels.MasterVideo, result *SyncResult) error {
...
func (s *MasterVideoSyncService) checkVideoConflicts(masterVideo *videoModels.MasterVideo) ([]*FieldConflict, error) {
	// Get current Bunny video
	bunnyVideo, err := s.bunnyService.GetVideo(masterVideo.BunnyVideoID)
	if err != nil {
...
func (s *MasterVideoSyncService) detectConflicts(masterVideo *videoModels.MasterVideo, bunnyVideo BunnyVideo) []*FieldConflict {
...
func (s *MasterVideoSyncService) determineBunnyUpdates(masterVideo *videoModels.MasterVideo, bunnyVideo BunnyVideo) map[string]interface{} {
...
func (s *MasterVideoSyncService) updateMasterFromResolution(masterVideo *videoModels.MasterVideo, resolution *ConflictResolution) error {
...
func (s *MasterVideoSyncService) updateBunnyFromResolution(masterVideo *videoModels.MasterVideo, resolution *ConflictResolution) error {
...
func (s *MasterVideoSyncService) updateBothFromResolution(masterVideo *videoModels.MasterVideo, resolution *ConflictResolution) error {
	// Update master
	err := s.updateMasterFromResolution(masterVideo, resolution)
	if err != nil {
		return err
