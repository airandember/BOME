-- Migration: Fix subscription offers table schema
-- Description: Drop and recreate subscription_offers table to ensure correct schema

-- Drop existing table if it exists
DROP TABLE IF EXISTS subscription_offers_history;
DROP TABLE IF EXISTS subscription_offers;

-- Create subscription_offers table with correct schema
