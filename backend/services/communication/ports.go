...
// This file defines the ports (interfaces) for the communication domain
// Implementations are in the email/ subdirectory

// EmailPort defines the interface for email operations
// Implementation: services/communication/email/email.go
